...
//  My Uber
//
//  Created by Dawid Jaskulski on 06/04/2020.
...
class CircularProgressView: UIView {
    ...
    private func circleShapeLayer(strokeColor: UIColor, fillColor: UIColor) -> CAShapeLayer {
        ...
        // -(pi /2) starting at the top of the circle
    ...
    func setProgressWithAnimation(duration: TimeInterval, value: Float, completion: @escaping() -> Void) {
        ...
        //circle start from value 1 and end on 0 (end,origin point when start, can gice any value between 1 and 0)
